...
const ChatWindow: React.FC<chatWindowProps> = ({ }) => {
    return (
        <div>
            <section className="flex fixed top-7 right-2 w-[95%] md:w-[400px] flex-col rounded-md justify-center antialiased bg-indigo-900 text-gray-600 min-h-[95vh] max-h-[720px] p-[10px]">
                <div className="h-auto">
                    ...
                    <div style={{overflowY:'scroll',WebkitOverflowScrolling:'touch', scrollbarWidth:'none'}} className="relative mx-auto mt-2 bg-white max-h-[70vh] shadow-lg rounded-lg">
                        ...
                        <button className="fixed bottom-[30px] right-8 inline-flex items-center text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 rounded-full text-center px-3 py-2 shadow-lg focus:outline-none focus-visible:ring-2">
